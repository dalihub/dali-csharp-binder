...
SWIGEXPORT int SWIGSTDCALL CSharp_Dali_TextEditor_Property_ENABLE_CURSOR_INSET_get()
{
  return (int)Dali::Toolkit::DevelTextEditor::Property::ENABLE_CURSOR_INSET;
}

SWIGEXPORT int SWIGSTDCALL CSharp_Dali_TextEditor_Property_ENABLE_DEFERRED_RELAYOUT_get()
{
  return (int)Dali::Toolkit::DevelTextEditor::Property::ENABLE_DEFERRED_RELAYOUT;
}
