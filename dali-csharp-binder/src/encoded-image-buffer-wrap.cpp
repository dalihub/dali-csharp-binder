...
#ifndef CSHARP_ENCODED_IMAGE_BUFFER
#define CSHARP_ENCODED_IMAGE_BUFFER
#endif
...
#define CALL_CATCH_EXCEPTION(ret)                                          \
  ...
  SWIGEXPORT void *SWIGSTDCALL CSharp_Dali_new_EncodedImageBuffer__SWIG_0()
  {
...

    {
      try
      {
        result = (Dali::EncodedImageBuffer *)new Dali::EncodedImageBuffer();
      }
  ...
  SWIGEXPORT void *SWIGSTDCALL CSharp_Dali_new_EncodedImageBuffer__SWIG_1(void *nuiEncodedImageBuffer)
  {
    ...
    Dali::EncodedImageBuffer *encodedImageBuffer = (Dali::EncodedImageBuffer *)0;

    encodedImageBuffer = (Dali::EncodedImageBuffer *)nuiEncodedImageBuffer;
    ...
    }
    {
      try
      {
        result = (Dali::EncodedImageBuffer *)new Dali::EncodedImageBuffer((Dali::EncodedImageBuffer const &)*encodedImageBuffer);
      }
      CALL_CATCH_EXCEPTION(0);
    }
  ...
  {
    void *jresult;
    Dali::EncodedImageBuffer::RawBufferType *buffer = (Dali::EncodedImageBuffer::RawBufferType *)0;
    Dali::EncodedImageBuffer result;

    buffer = (Dali::EncodedImageBuffer::RawBufferType *)nuiRawBuffer;
    if (!buffer)
    {
