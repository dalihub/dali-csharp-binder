...
SwigDirector_ViewWrapperImpl::SwigDirector_ViewWrapperImpl(Dali::Toolkit::Internal::ControlWrapper::CustomControlBehaviour behaviourFlags)
: Dali::Toolkit::Internal::ControlWrapper(behaviourFlags)
{
  swig_init_callbacks();
}
...
Dali::Toolkit::ControlImpl::Extension* SwigDirector_ViewWrapperImpl::GetControlExtension()
{
