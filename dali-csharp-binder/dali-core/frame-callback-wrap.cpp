...
SWIGEXPORT bool SWIGSTDCALL CSharp_Dali_FrameCallbackInterface_BakeCustomProperty(void* updateProxy, unsigned int id, char* propertyName, void* csPropertyValue)
{
  Dali::UpdateProxy*           proxy = (Dali::UpdateProxy*)updateProxy;
  const Dali::Property::Value* value = (const Dali::Property::Value*)csPropertyValue;
  return proxy->BakeCustomProperty(id, propertyName, *value);
}

SWIGEXPORT bool SWIGSTDCALL CSharp_Dali_FrameCallbackInterface_GetCustomProperty(void* updateProxy, unsigned int id, char* propertyName, void* csPropertyValue)
{
  Dali::UpdateProxy*     proxy = (Dali::UpdateProxy*)updateProxy;
  Dali::Property::Value* value = (Dali::Property::Value*)csPropertyValue;
  return proxy->GetCustomProperty(id, propertyName, *value);
}
